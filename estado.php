...
<body>
    ...
    <?php
        ...
        if($tipo == 1){
            $consulta = $pdo->query("SELECT * FROM estado
                                WHERE id_estado LIKE '$procurar%' 
                                ORDER BY id_estado");}

        else if($tipo == 2){
            $consulta = $pdo->query("SELECT * FROM estado
                                WHERE nome_est LIKE '$procurar%' 
                                ORDER BY nome_est");}
    ...
    while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {   
        ...
        <tr><td><?php echo $linha['id_estado'];?></td>
            ...
            <td><?php echo " <a href=javascript:excluirRegistro('acaoI.php?acaoI=excluir&id_estado={$linha['id_estado']}')>"; ?><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M13.854 2.146a.5.5 0 0 1 0 .708l-11 11a.5.5 0 0 1-.708-.708l11-11a.5.5 0 0 1 .708 0Z"/>
  <path fill-rule="evenodd" d="M2.146 2.146a.5.5 0 0 0 0 .708l11 11a.5.5 0 0 0 .708-.708l-11-11a.5.5 0 0 0-.708 0Z"/>
</svg></a></td>
        <td><?php echo "<a href='cadest.php?acaoI=editar&id_estado={$linha['id_estado']}')>";?><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wrench" viewBox="0 0 16 16">
